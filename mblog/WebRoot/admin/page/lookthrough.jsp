		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="<%=basePath%>/admin/page/lookthrough.jsp">日志管理</a></li>
				</ul>
				<ul class="nav nav-sidebar">
					<li><a href="#">设置</a></li>
					<li><a href="#">帮助</a></li>
										...
										<tr>
											...
											<td>
												<%
													if(a.getAtype()==1){
														%>
														<img width="100px" src="<%=basePath %>upload/<%=a.getImg() %>" alt="" />
														<%
													}else{
														%>
														<img width="100px" src="<%=basePath %>upload/userInfo/<%=a.getUserinfo().getUserImg() %>" alt="" />
														<%
													}
												%>
											</td>
											...
											<td><a href="<%=basePath%>/Article/del?aid=<%=a.getAid()%>">删除</a></td>
										</tr>
										<%
											}
										%>
